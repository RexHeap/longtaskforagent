...
### 8. `CLAUDE.md` (appended, not overwritten)
...
### Phase 8: Clear context and continue
...
26. Execute `/clear`
27. After clear, send: `"Continue working on this project. Read long-task-guide.md for instructions."`

...
|--------|---------|---------|---------|----------|--------|------|
| FR-001 | {摘要} | {场景1/场景2/...} | FUNC,BNDRY,{+其他} | N | Critical/High/Medium/Low | {选择理由} |
| ... | ... | ... | ... | ... | ... | ... |
...
| Req ID | 需求摘要 | 验收场景 | 必须类别 | 最低用例数 | 优先级 | 备注 |
|--------|---------|---------|---------|----------|--------|------|
| IFR-001 | {摘要} | {场景} | FUNC,BNDRY | N | {优先级} | {协议/格式说明} |
| ... | ... | ... | ... | ... | ... | ... |
